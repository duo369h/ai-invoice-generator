...
const markup = String.raw`
  ...
  <!-- GLOBAL HEADER MODULE (EXACT FROZEN HOME-01 V1.2.2 CONTRACT) -->
  <header class="site-header" id="siteHeader">
    <!-- BRAND WORDMARK ONLY -->
    <a href="/" class="brand-logo">
      <span class="wordmark">Corvioz</span>
    </a>
    ...
    <nav class="main-nav" aria-label="Global Navigation">
      ...
      <div class="nav-disclosure">
        <button class="nav-disclosure-btn" id="howItWorksBtn" aria-expanded="false" aria-controls="howItWorksDropdown">
          <span>How It Works</span>
          <svg class="chevron-icon" viewBox="0 0 16 16" fill="none"><path d="M4 6L8 10L12 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          <span class="underline-indicator"></span>
        </button>
        <div class="header-dropdown connected" id="howItWorksDropdown" role="region" aria-labelledby="howItWorksBtn" hidden>
      ...
      <!-- FOR PHOTOGRAPHERS -->
      <a href="/for-photographers" class="nav-link">
      ...
      <div class="nav-disclosure">
        <button class="nav-disclosure-btn" id="resourcesBtn" aria-expanded="false" aria-controls="resourcesDropdown">
          <span>Resources</span>
          <svg class="chevron-icon" viewBox="0 0 16 16" fill="none"><path d="M4 6L8 10L12 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          <span class="underline-indicator"></span>
        </button>
        <div class="header-dropdown connected" id="resourcesDropdown" role="region" aria-labelledby="resourcesBtn" hidden>
    ...
    <!-- CODEX-07: mobile navigation is a contained panel, not an overlay. -->
    <button class="mobile-menu-btn" id="mobileMenuButton" type="button" aria-label="Open navigation menu" aria-expanded="false" aria-controls="mobileNavPanel">
      <span class="mobile-menu-icon" aria-hidden="true"><span></span><span></span><span></span></span>
    </button>
    <nav class="mobile-nav-panel" id="mobileNavPanel" aria-label="Mobile navigation" hidden>
      <div class="mobile-nav-group">
        <button class="mobile-nav-group-btn" id="mobileHowItWorksBtn" type="button" aria-expanded="false" aria-controls="mobileHowItWorksPanel">How It Works</button>
        <div class="mobile-nav-group-panel" id="mobileHowItWorksPanel" role="region" aria-labelledby="mobileHowItWorksBtn" hidden>
          <a href="/#how-corvioz-works">Workflow</a>
          <a href="/#features">Features</a>
          <a href="/#client-journey">Client Journey</a>
        </div>
      </div>
      <a href="/for-photographers">For Photographers</a>
      <a href="/pricing">Pricing</a>
      <div class="mobile-nav-group">
        <button class="mobile-nav-group-btn" id="mobileResourcesBtn" type="button" aria-expanded="false" aria-controls="mobileResourcesPanel">Resources</button>
        <div class="mobile-nav-group-panel" id="mobileResourcesPanel" role="region" aria-labelledby="mobileResourcesBtn" hidden>
          <a href="/#guides">Guides</a>
          <a href="/quote-template">Templates</a>
          <a href="/blog">Blog</a>
      ...
      <a href="/signup?redirect=%2Fdashboard%3Ftool%3Dquote%26mode%3Dcreate%26flow%3Dfirst-quote" class="mobile-nav-cta">Create Quote</a>
    </nav>
    ...
    <div class="header-actions">
      <a href="/dashboard" class="text-link">
        <span>Sign in</span>
        <span class="underline-indicator text-link-underline"></span>
      </a>
      <a href="/signup?redirect=%2Fdashboard%3Ftool%3Dquote%26mode%3Dcreate%26flow%3Dfirst-quote" class="btn-primary-header">Create Quote</a>
    </div>
  </header>
