export const blogPosts = [
  {
    ...
    keywords: ['freelance pricing', 'value based pricing', 'web design pricing'],
    sections: [
      {
        id: 'toc-1',
      ...
      {
        id: 'toc-2',
        heading: '2. The Discovery Conversation Formula',
        paragraphs: [
          'To charge value-based flat rates, you must identify the commercial outcome of the project. During brief intakes, ask why the redesign is happening now, what the current site is failing to do, and what a successful outcome is worth to the client.',
        ],
      },
      {
        id: 'toc-3',
        heading: '3. Structuring a 3-Tier Option Quote',
        paragraphs: [
          'Never send a quote with a single price tag. A single price turns you into a yes-or-no commodity. Present three choices representing different scopes: essential, standard, and premium.',
        ],
        bullets: [
          'Essential: core deliverables to fix the immediate pain point.',
          'Standard: core build plus responsiveness, handoff, and QA.',
          'Premium: full-service strategy, launch, support, and optimization.',
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: 'toc-2',
        heading: '2. The Landing Page Friction Bar',
        paragraphs: [
          'A standard portfolio website often forces a client to look through scattered projects and hunt for contact details. A focused profile page should show services, industry, starting rate, proof, and a quote request CTA.',
        ],
      },
    ],
    faq: [
      ...
      {
        question: 'What should a client see before requesting a quote?',
        answer: 'They should see your services, starting rate, portfolio proof, response expectations, and a direct request quote CTA.',
      },
    ],
    internalLinks: [
  ...
  {
    slug: 'invoice-vs-quote-vs-receipt',
    category: 'Invoices',
    title: 'Invoice vs Quote vs Receipt: What Freelancers Should Send and When',
    description: 'A simple guide to the difference between quotes, invoices, and receipts in a freelance client workflow.',
    date: 'June 12, 2026',
    readTime: '5 min read',
    author: 'Corvioz Team',
    ...
    sections: [
      {
        id: 'toc-1',
        heading: '1. Quote: Before the Work Starts',
        paragraphs: [
    ...
    faq: [
      {
        question: 'Should I send a quote or an invoice first?',
        answer: 'Send a quote before the project starts. Send an invoice after the client approves scope, a milestone is reached, or work is delivered.',
      },
      {
        question: 'Can a quote become an invoice?',
        answer: 'Yes. A connected quote-to-invoice workflow keeps scope, pricing, and terms consistent.',
      },
    ],
    internalLinks: [
...
export const blogSeoSlugs = blogPosts.map((post) => post.slug);

export function getBlogPost(slug) {
  return blogPostMap[slug] || null;
}
