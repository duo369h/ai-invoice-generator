const industries = [
  {
    ...
    invoiceExampleFields: ['Session or project name', 'Shoot date', 'Editing package', 'Licensing usage', 'Deposit paid', 'Final balance due'],
  ...
  },
  {
    ...
    invoiceExampleFields: ['Retainer period', 'Advisory hours', 'Workshop sessions', 'Research deliverables', 'Approved expenses', 'Payment terms'],
  ...
  },
  {
    ...
    invoiceExampleFields: ['Page package', 'Design phase', 'Responsive QA', 'CMS setup', 'Launch support', 'Milestone payment'],
  ...
  },
  {
    ...
    invoiceExampleFields: ['Sprint or milestone', 'Feature scope', 'Engineering hours', 'Deployment support', 'Maintenance terms', 'Payment schedule'],
  ...
  },
  {
    ...
    plural: 'marketers',
    label: 'Marketer',
    audience: 'growth marketers, paid media specialists, SEO freelancers, and campaign strategists',
  ...
  },
  {
    ...
    invoiceExampleFields: ['Copy asset', 'Word count or page count', 'Research time', 'Revision rounds', 'Delivery format', 'Final payment'],
  ...
  },
  {
    ...
    invoiceExampleFields: ['Billing period', 'Hours used', 'Task category', 'Tool access costs', 'Overage rate', 'Next renewal date'],
  ...
  },
  {
    ...
    invoiceExampleFields: ['Job address', 'Labor line items', 'Materials', 'Change orders', 'Deposit paid', 'Final balance'],
...
export const coreMoneyPages = {
  '/invoice-generator': {
    ...
    seoTitle: 'Invoice Generator for Freelancers in the US & Canada',
    description: 'Create professional freelancer invoices with client details, line items, taxes, payment links, PDF export, and payment status tracking in Corvioz.',
    h1: 'Invoice Generator for Freelancers',
    intro: 'Create a clean, client-ready invoice without wrestling with accounting software. Corvioz helps freelancers in the US and Canada turn completed work into professional invoices with clear line items, payment terms, and PDF export.',
    primaryCta: 'Create Invoice',
    primaryHref: '/dashboard?tool=invoice',
    secondaryCta: 'Create Quote First',
    secondaryHref: '/quote-generator',
    useCases: ['Send invoices for project milestones', 'Track pending, paid, and overdue balances', 'Attach payment links and export branded PDFs'],
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'Yes. Corvioz is designed around common US and Canadian freelance workflows, including client details, tax fields, PDF export, and payment instructions.',
      },
      {
        question: 'Can I add my own payment link?',
        answer: 'Yes. You can include your own payment instructions or payment link so clients know exactly how to pay the invoice.',
      },
    ],
  },
  '/quote-generator': {
    ...
    faq: [
      {
        ...
        answer: 'No. A quote estimates the scope and price before work starts. An invoice requests payment after work is approved or delivered.',
      },
      {
...
const programmaticCountries = [
  ['us', 'US', 'freelancers billing clients in the United States'],
  ...
  ['canada', 'Canada', 'freelancers and contractors billing Canadian clients'],
...
const programmaticUseCases = [
  ['client-billing', 'Client Billing', 'freelancers who need a clear client billing workflow'],
  ['project-estimate', 'Project Estimate', 'project-based service providers preparing estimates'],
  ['milestone-payment', 'Milestone Payment', 'freelancers billing by project milestones'],
  ['retainer', 'Retainer', 'consultants and agencies selling monthly retainers'],
  ['hourly-work', 'Hourly Work', 'service providers billing tracked hourly work'],
  ['fixed-price-project', 'Fixed Price Project', 'freelancers selling fixed-scope projects'],
  ['deposit-payment', 'Deposit Payment', 'professionals collecting deposits before work starts'],
  ...
  ['web-design-project', 'Web Design Project', 'web designers quoting and billing website work'],
  ['software-project', 'Software Project', 'developers quoting and billing software projects'],
  ['marketing-campaign', 'Marketing Campaign', 'marketers billing campaign work and retainers'],
  ['photo-shoot', 'Photo Shoot', 'photographers billing sessions and deliverables'],
  ['content-package', 'Content Package', 'writers and creators selling content packages'],
  ['maintenance-work', 'Maintenance Work', 'freelancers billing support and maintenance'],
  ['subscription-service', 'Subscription Service', 'providers selling recurring services'],
  ['tax-ready-records', 'Tax Ready Records', 'freelancers keeping cleaner income records'],
];
...
export const matrixSeoTypes = [
  ...
  },
  {
    ...
    challenge: 'making shoot fees, editing, rush delivery, and usage rights visible before the client pays',
  },
  {
    slug: 'writer',
    label: 'Writer',
    ...
    challenge: 'billing for research, drafts, revision limits, and final delivery without hiding the strategy work',
  },
  {
    slug: 'agency',
    label: 'Agency',
  ...
  },
  {
    ...
    challenge: 'showing labor, materials, deposits, and change-order notes clearly enough to prevent payment disputes',
  },
];
...
export const matrixSeoCountries = [
  {
    ...
    taxRate: 0.075,
    paymentTerms: 'Net 15',
    paymentMethod: 'ACH transfer or card payment link',
    localDetail: 'US clients often expect a clear W-9-ready business name, payment terms, and sales-tax treatment when applicable.',
  },
  {
    slug: 'canada',
    label: 'Canada',
    ...
    taxRate: 0.13,
    paymentTerms: 'Net 14',
    paymentMethod: 'Interac e-Transfer, bank transfer, or card payment link',
  ...
  },
  {
    ...
    taxRate: 0.2,
    paymentTerms: 'Net 14',
    paymentMethod: 'bank transfer or online payment link',
    localDetail: 'UK clients commonly expect VAT treatment, company details, and bank-transfer instructions to be visible on the document.',
  },
  {
    slug: 'australia',
    label: 'Australia',
    ...
    taxRate: 0.1,
    paymentTerms: 'Net 7',
    paymentMethod: 'bank transfer, PayID, or card payment link',
    localDetail: 'Australian clients often expect GST clarity, ABN-style business details, and short payment windows for project work.',
  },
  {
    slug: 'germany',
    label: 'Germany',
    ...
    taxRate: 0.19,
    paymentTerms: 'Net 14',
    paymentMethod: 'SEPA bank transfer or online payment link',
    localDetail: 'German clients tend to expect precise line items, VAT notes, invoice numbering, and formal payment instructions.',
  },
  {
    slug: 'singapore',
    label: 'Singapore',
    ...
    taxRate: 0.09,
    paymentTerms: 'Net 7',
    paymentMethod: 'bank transfer, PayNow, or card payment link',
    localDetail: 'Singapore clients often value concise billing, GST visibility where applicable, and fast digital payment instructions.',
  },
];
...
export const matrixSeoUseCases = [
  ...
  },
  {
    ...
    billingModel: 'fixed project pricing',
  ...
  },
  {
    ...
    billingModel: 'contract milestone billing',
    timing: 'when a contract phase is approved',
    pricingNote: 'contract references, phase names, and acceptance dates',
    risk: 'payment delays when the invoice does not match the signed agreement',
  },
  {
    slug: 'branding',
    label: 'Branding',
...
function getMatrixEntry(collection, slug) {
  ...
  return collection.find((entry) => entry.slug === normalizedSlug) || {
    ...
    challenge: 'keeping scope, pricing, and payment terms clear',
    currency: 'USD',
    symbol: '$',
    taxLabel: 'tax',
    taxRate: 0,
    paymentTerms: 'Net 14',
    paymentMethod: 'bank transfer or online payment link',
    localDetail: 'Clients expect clear business details, line items, totals, and payment instructions.',
    billingModel: `${titleCase(normalizedSlug).toLowerCase()} billing`,
    timing: 'when the client is ready to review the document',
    pricingNote: 'clear line items and totals',
    risk: 'unclear scope or payment terms',
  };
}
...
function buildMatrixExample({ isInvoice, productNoun, type, country, useCase }) {
  ...
  const lineItems = isInvoice
    ? [
        ...
        {
          description: `Final handoff, records, and ${country.label} payment setup`,
  ...
  return {
    ...
    note: isInvoice
      ? `Payment by ${country.paymentMethod}. This ${productNoun} covers ${useCase.context} for ${type.project} in ${country.label}.`
  ...
  return [
    {
      ...
      answer: `It uses ${country.currency} examples, ${country.taxLabel} language, ${country.paymentTerms} terms, and payment notes that fit ${country.audience}.`,
    },
    {
      question: `How should ${typeLower}s describe ${useCaseLower} work?`,
      answer: `Describe the billing model as ${useCase.billingModel}, list the deliverables separately, and explain the timing: ${useCase.timing}.`,
    },
    {
      question: `What should the example ${productNoun} include?`,
      answer: `It should include client details, document number, issue date, line items, ${country.taxLabel}, total, payment method, and a note about ${useCase.context}.`,
    },
    {
      question: isInvoice ? 'Should I send a quote before this invoice?' : 'Can this quote become an invoice later?',
      answer: isInvoice
        ? `For ${useCase.context}, a quote helps the client approve scope before the invoice requests payment.`
        : `Yes. A clear quote can become a matching invoice after the client approves the ${useCaseLower} scope.`,
    },
    {
      question: `How does Corvioz reduce payment friction for ${typeLower}s?`,
      answer: `Corvioz keeps the ${productNoun}, client profile, pricing details, and related ${productPlural} connected so clients see a professional path from scope to payment.`,
    },
  ];
}
...
export function buildMatrixSeoPage(productType, params = {}) {
  ...
  const useCaseLower = useCase.label.toLowerCase();
  const mainAction = isInvoice ? 'request payment' : 'get client approval';
  ...
  const seoParagraphs = [
    ...
    `For ${typeLower}s, the most important detail is not only the final price but the reason behind each line item. This page names the service context, the client type, the regional payment expectation, and the billing risk that often creates friction. In this case, the risk is ${useCase.risk}. By making that risk visible, the ${productNoun} can prevent follow-up questions before they slow down payment or approval. The ${country.label} context also changes the document: ${country.localDetail}`,
  ...
  return {
    ...
    description: `AI ${productNoun} generator for ${typeLower} in ${countryLower}, optimized for ${useCaseLower} billing.`,
...
export function buildMatrixCountryPage(productType, params = {}) {
  ...
  return {
    ...
    body: `${type.label}s working with ${country.audience} often need more than a generic ${productNoun} form. ${country.localDetail} This hub connects the main ${productNoun} generator to specific billing scenarios such as hourly work, fixed projects, retainers, contracts, and branding packages. Use it as the country-level entry point before choosing a detailed use-case page with a full example, FAQ, and matching ${isInvoice ? 'quote' : 'invoice'} workflow.`,
    useCaseLinks,
    internalLinks: [
      { href: '/', label: 'Corvioz Home' },
...
export function buildProgrammaticSeoPage(productType, slug) {
  ...
  const actionVerb = isInvoice ? 'bill clients' : 'estimate projects';
  const outcome = isInvoice ? 'request payment' : 'win approval before work begins';
  ...
  return {
    ...
    sections: {
      ...
      example: isInvoice
        ? [
            ...
            'Project milestone or billing period',
            'Line items with quantity, rate, subtotal, tax, and balance due',
            'Payment instructions, due date, and optional payment link',
          ]
        : [
    ...
    internalLinks: [
      ...
      { href: '/card/demo', label: 'Public Profile Example' },
      { href: '/pricing', label: 'Pricing' },
      { href: otherPath, label: isInvoice ? 'Create a Quote First' : 'Create an Invoice After Approval' },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer: `Include client details, your business information, itemized scope, pricing, dates, payment terms, notes, and any project-specific details the client needs to approve or pay.`,
      },
      {
        question: isInvoice ? 'Can I turn a quote into an invoice?' : 'Can I turn this quote into an invoice later?',
        answer: 'Yes. Corvioz is built around a connected quote-to-invoice workflow so approved scope and pricing can become a client-ready payment request.',
      },
    ],
  };
}
...
export function buildTemplatePageData(type, industry) {
  ...
  const fieldContext = isInvoice ? 'payment request' : 'estimate';
  ...
  return {
    ...
    description: `Use this ${industry.singular} ${documentName.toLowerCase()} to structure ${isInvoice ? 'client billing' : 'client estimates'} with clear scope, fields, FAQs, and a fast path to create a ${isInvoice ? 'professional invoice' : 'client quote'}.`,
    ...
    faq: [
      {
        ...
        answer: `It should include client details, your business details, itemized scope, pricing, dates, payment terms, and any ${industry.singular}-specific details such as ${industry.deliverables.slice(0, 3).join(', ')}.`,
      },
      {
        question: `Can I customize this ${documentName.toLowerCase()} in Corvioz?`,
        answer: `Yes. Use the template fields as a starting point, then adjust descriptions, quantities, rates, taxes, notes, and payment terms before sending.`,
      },
      {
