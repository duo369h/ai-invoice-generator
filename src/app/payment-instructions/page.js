...
export const metadata = {
  title: 'Payment Instructions — InvoiceAI Pro',
  description:
    'How to upgrade to InvoiceAI Pro via PayPal. Step-by-step payment instructions for cross-border PayPal payment.',
};
...
export default function PaymentInstructionsPage() {
  ...
  const steps = [
    {
      num: '01',
      title: 'Choose Pro Plan',
      body: 'You\'ve selected the InvoiceAI Pro plan at $9 / month. This unlocks unlimited invoices, 100 AI auto-fills per month, and custom branding.',
    },
    {
      num: '02',
      title: 'Request a PayPal Payment',
      body: (
        <>
          Click the PayPal payment request button below and email us your registered account address.
          Our team will send you a <strong style={{ color: 'var(--text-main)' }}>$9.00 USD</strong> PayPal
          payment request or PayPal invoice. Please include your InvoiceAI account email in the payment
    ...
    {
      num: '03',
      title: 'Email Us Your Receipt',
      body: (
        <>
          After payment, send the PayPal transaction confirmation to{' '}
          <a href={`mailto:${supportEmail}`} style={{ color: 'var(--primary)', textDecoration: 'underline' }}>
            {supportEmail}
          </a>
          {' '}with the subject line{' '}
          <strong style={{ color: 'var(--text-main)' }}>&ldquo;InvoiceAI Pro Upgrade&rdquo;</strong>.
          Include your name and the email address you use on InvoiceAI.
        </>
      ),
    },
    {
      ...
      <main style={{ flex: 1, padding: '80px 24px 60px' }}>
        <div className="animate-fade-in" style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '52px', maxWidth: '620px' }}>
            InvoiceAI accepts PayPal for cross-border Pro plan payments. Customers start from the
            pricing page, request a PayPal payment, complete the PayPal invoice or payment request,
            and email the receipt to our support team. Because automatic subscription billing is
            still being prepared, Pro access is currently activated{' '}
            <strong style={{ color: 'var(--text-main)' }}>manually by our team</strong>{' '}
            after we verify your PayPal receipt. The process is straightforward and usually
            takes a few hours.
          </p>
          ...
          {/* ── SUMMARY CARD ─────────────────────────────────────── */}
          <div className="card" style={{ marginTop: '56px', padding: '32px', borderColor: 'rgba(255,196,57,0.25)', background: 'rgba(255,196,57,0.04)' }}>
            <h3 style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFC439" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4m0 4h.01"/></svg>
              Payment Summary
            </h3>
          ...
          <div style={{ marginTop: '48px', display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
            <a
              href={`mailto:${supportEmail}?subject=InvoiceAI Pro PayPal Payment Request&body=Hi, I want to upgrade to InvoiceAI Pro. Please send me a PayPal payment request for $9 USD. My InvoiceAI account email is: `}
            ...
            <a
              href={`mailto:${supportEmail}?subject=InvoiceAI Pro Upgrade&body=Hi, I've sent a PayPal payment for InvoiceAI Pro. My email is: `}
