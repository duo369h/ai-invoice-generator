...
export default function ProposalCreationFlow() {
...
${proposal.cta || ''}`;
  ...
  return (
    <>
    <div data-creation-stage={creationStage} style={{ minHeight: '100vh', backgroundColor: 'var(--bg-page)', color: 'var(--text-main)', fontFamily: 'var(--font-sans)', padding: '40px 20px' }}>
            ...
            <form onSubmit={handleGenerate} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                ...
                <textarea 
                  ...
                  onChange={(e) => {
                    setCreationStage('input');
                    setClientContext(e.target.value);
                  }}
