...
export const dataHandlingMap: DataMapEntry[] = [
  {
    ...
    purpose: 'Authenticate users, restore sessions, attach records to the correct workspace, and manage entitlement state.',
  ...
  },
  {
    ...
    purpose: 'Create, edit, export, and share client-ready freelancer documents.',
  ...
  },
  {
    ...
    retention: 'Retained while the account or workspace record remains active unless deletion is requested.',
  },
  {
